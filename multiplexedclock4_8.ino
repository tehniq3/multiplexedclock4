...
ver.4.8 - if is night, show juct clock
*/
...
#define DIODA A3  // pin for conect 1n4148 diode and GND
const int t0 = 20.3;
...
DISPLAY_BRIGHTNESS = analogRead(LDR); Serial.println(DISPLAY_BRIGHTNESS);
// display parts   
